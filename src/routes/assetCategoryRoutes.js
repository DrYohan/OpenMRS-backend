...
router.post("/sub-categories", assetCategoryController.createSubCategory);
router.get("/sub-categories", assetCategoryController.getAllSubCategories);
router.get("/sub-categories/:id", assetCategoryController.getSubCategoryById);
router.put("/sub-categories/:id", assetCategoryController.updateSubCategory);
router.delete("/sub-categories/:id", assetCategoryController.deleteSubCategory);
router.get(
