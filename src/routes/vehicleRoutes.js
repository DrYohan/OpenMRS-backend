...
router.get(
  "/by-registration/:registrationId",
  VehicleController.getVehicleByRegistrationId
);
...
router.get(
  ...
  VehicleController.getMiddleCategoriesByStation
);
router.get(
  "/sub-categories/:middleCategory",
  VehicleController.getSubCategoriesByMiddleCategory
);
router.get(
  "/registrationId/:station/:middleCategory/:subCategory",
  VehicleController.getRegistrationIdBySlectedValues
);
